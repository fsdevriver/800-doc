...
| `status` | `VARCHAR(40)` | `NOT NULL, DEFAULT 'ORDER_CREATED'` | Lifecycle state: `ORDER_CREATED`, `ASSIGNED`, `EN_ROUTE`, `ARRIVED`, `WASHING`, `PAYMENT_PENDING`, `COMPLETED`, `CANCELLED_BY_CUSTOMER`, `CANCELLED_WITH_PENALTY`, `CANCELLED_NO_SHOW`. |
